...
- [ ] Establish a reproducible visual-test baseline. On 2026-09-25, Flutter 3.47.0 / Dart 3.13.0 passed analysis and 13 tests; two tests failed on golden comparisons. Investigate platform/SDK rendering differences rather than blindly replacing reference images.
- [ ] Audit sprites in motion: worker typing/stress/celebration/report, boss walking both directions and gesturing, and all four room tiers. Fix confirmed clipping, stretching, anchor drift, edge halos, and implausible relative scale before building on affected artwork.

## Features, in delivery order

- [ ] **F01 — Projects with tradeoffs:** ship a Friday presentation with solo, collaborative, and rushed approaches; show costs and rewards; persist active/completed state; prevent duplicate rewards. Then add routine and team projects.
